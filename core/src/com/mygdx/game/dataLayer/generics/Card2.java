...
public class Card2 extends Image {
    ...
    public Card2(String id, TextureRegion back, TextureRegion front, Vector2 targetPos, Vector2 spawnPos, final NewGameScreen newGameScreen) {
        super(back);
